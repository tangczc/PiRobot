	...
	else
	{
		...
		for(i=0;i<=maxi;i++)
		{
			...
			//	printf("m = %d",m);
	     			    switch(m)
		         	    {
					case 1:MOTOR_GO_FORWARD; printf("forward\n");break;
					case 2:MOTOR_GO_BACK;    printf("back\n");break;            						
					case 4:MOTOR_GO_LEFT;    printf("right\n");break;
					case 3:MOTOR_GO_RIGHT;   printf("left\n");break;
					case 0:MOTOR_GO_STOP;    printf("stop\n");break;
					default: break;
				    }
				    digitalWrite(3, HIGH);
				}
